...
**Защита = качество init-документации**, а не процесс. На Foundation-фазе зафиксированы зоны, owner'ы публичных схем, cross-module карта и API-конвенции — все следуют этому документу.

Если кто-то всё же изменил общую зону «попутно» — не катастрофа, поправим вместе. Никаких pre-commit hooks, никаких обязательных аппрувов, никаких уведомлений в чат. Принимаем риск — выбираем скорость.

Гигиена: одна осмысленная единица изменения = один PR. Не смешивай правки общей зоны с фичей — отдельный коммит/PR, чтобы потом было видно в истории.
