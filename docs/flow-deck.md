...
Cross-approve не нужен. Verification skill, reflexion, code review — **опциональны**.
...
**Меняешь — кинь сообщение в командный чат.** Без RFC-PR, без обязательных аппрувов.
Один осмысленный change = один PR (не мешай с фичей).

Не согласен — обсуждаем в комментах PR.
